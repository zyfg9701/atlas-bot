...
> **默认仍 cli；box 旁路（可选 LLM）见 [`private-resident-runtime-runbook.md`](./private-resident-runtime-runbook.md)。** 危险命令人闸见 [`tool-approval-runbook.md`](./tool-approval-runbook.md)（**CG1 cli 须 `ATLAS_AGENT_CLI_STREAM=1`**；GA1 box；默认仍 cli；非 GA2/YOLO；cli≠box 零副作用）。 真模型黄标证据包（RL1）：同 runbook § 真模型黄标 · [`rr1-live-llm-handtest-checklist.md`](./rr1-live-llm-handtest-checklist.md)。
